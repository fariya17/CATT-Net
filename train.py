...
class HybridLSTMTransformerModel:
    ...
    def save(self, model_path, preprocessor_path):
        ...
        preprocessor_path : str
            Path to save preprocessors (scaler, PCA, label_encoder)
        """
        if self.model is None:
...
def parse_args():
    ...
    parser.add_argument('--components', type=int, default=20, help='Number of PCA components')
...
def main():
    ...
    X = dataset.drop(columns=[args.target])
    y = dataset[args.target]
    ...
    print(f"Saving preprocessors to {preprocessor_path}...")
